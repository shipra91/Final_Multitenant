<?php
    ...
    class StudentClassTimeTableService {
        ...
        public function getStudentTimeTableData($studentId, $institutionId , $academicYear ){
            ...
            $studentData = $studentMappingRepository->fetchStudent($studentId);
            ...
            $standardSubjects = $standardSubjectRepository->fetchStandardSubjects($idStandard);
            ...
            foreach($standardSubjects as $subject){
                ...
                $subjectTypeDetails = $subjectService->fetchSubjectTypeDetails($institutionSubjectData->id_subject);

                if($subjectTypeDetails != 'common'){

                    $data['subjectId'] = $institutionSubjectId;
                    $checkStudentSubject = $studentMappingRepository->checkSubjectMappedToStudent($data);
