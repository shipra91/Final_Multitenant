<?php 
    ...
    class SMSTemplateService {
        public function getAll($allSessions){
            ...
            $smsTemplates = $SMSTemplateRepository->all($allSessions);
        ...
        public function getDeletedRecords($allSessions){
            ...
            $data = array();
            $arrayTemplates = array();
            $allSmsTemplates = $SMSTemplateRepository->allDeleted($allSessions);
        ...
        public function getInstitutionSenderId($allSessions) {
            ...
            $senderIdDetails = $SMSTemplateRepository->getInstitutionSenderId($allSessions);
            return $senderIdDetails;
        }

        public function getSmsTemplatesUsingSenderId($request, $allSessions) {
            $SMSTemplateRepository = new SMSTemplateRepository(); 
            $senderId = $request['senderId'];
            $senderIdDetails = $SMSTemplateRepository->getSmsTemplatesUsingSenderId($senderId, $allSessions);
            return $senderIdDetails;
        }
