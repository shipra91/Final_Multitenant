...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbl_student_electives', function (Blueprint $table) {
            ...
            $table->uuid('id_elective')->foreign('id_elective')->references('id')->on('tbl_subject')->onDelete('cascade');    
    ...
    {
        Schema::dropIfExists('tbl_student_electives');
    }
};
