...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbl_exam_subject_configuration', function (Blueprint $table) {
            ...
            $table->string('subject_part');
            $table->Integer('priority');
            $table->Enum('conversion', ['NO','YES']);
    ...
    {
        Schema::dropIfExists('tbl_exam_subject_configuration');
    }
};
