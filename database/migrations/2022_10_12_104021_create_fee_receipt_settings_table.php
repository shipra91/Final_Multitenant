...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbl_fee_receipt_settings', function (Blueprint $table) {
            ...
            $table->Integer('receipt_no_sequence');
            $table->String('receipt_size');
    ...
    {
        Schema::dropIfExists('tbl_fee_receipt_settings');
    }
};
