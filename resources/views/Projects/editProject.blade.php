            ...
            <div class="container-fluid">
                <div class="row">
                    <form method="POST" class="demo-form" id="projectForm">
                        <input type="hidden" name="project_id" id="project_id" value="{{ $project['projectData']->id }}">
                        <div class="col-lg-8">
                            <div class="card">
                                ...
                                <div class="card-content">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="selectpicker" name="project_class" id="project_class" data-size="5" data-style="select-with-transition" data-live-search="true" title="Select" required="required" data-parsley-errors-container=".standardError">
                                                    @foreach($projectDetails['standard'] as $standard)
                                                        <option value="{{ $standard['institutionStandard_id'] }}" @if($project['projectData']->id_standard == $standard['institutionStandard_id']) {{'selected'}} @endif>{{ $standard['class'] }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="selectpicker" name="project_subject" id="project_subject" data-size="5" data-style="select-with-transition" data-live-search="true" title="Select" required="required" data-parsley-errors-container=".subjectError">
                                                    @foreach($projectDetails['subject'] as $subject)
                                                        <option value="{{ $subject['id'] }}" @if($project['projectData']->id_subject == $subject['id']) {{'selected'}} @endif>{{ $subject['name'] }}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="selectpicker" name="project_staff" id="project_staff" data-size="5" data-style="select-with-transition" data-live-search="true" title="Select" required="required" data-parsley-errors-container=".teacherError">
                                                    @foreach($projectDetails['staff'] as $staff)
                                                        <option value="{{ $staff->id }}" @if($project['projectData']->id_staff == $staff->id) {{'selected'}} @endif>{{ $staff->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="project_chapter_name" value="{{ $project['projectData']->chapter_name }}" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control datepicker startDate" name="project_start_date" value="{{ Carbon::createFromFormat('Y-m-d', $project['projectData']->start_date)->format('d/m/Y') }}" data-parsley-trigger="change" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control datepicker endDate" name="project_end_date" value="{{  Carbon::createFromFormat('Y-m-d', $project['projectData']->end_date)->format('d/m/Y') }}" data-parsley-trigger="change" required autocomplete="off"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control timepicker" name="project_start_time" value="{{ $project['projectData']->start_time }}" data-parsley-trigger="change" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control timepicker" name="project_end_time" value="{{ $project['projectData']->end_time }}" data-parsley-trigger="change" required />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label mt-0">Project Name<span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="project_name" value="{{ $project['projectData']->name }}" required />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <textarea class="ckeditor" name="project_details">{{ $project['projectData']->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="selectpicker" name="submission_type" id="submission_type" data-size="5" data-style="select-with-transition" data-live-search="true" title="Select" required="required" data-parsley-errors-container=".typeError">
                                                    <option value="ONLINE" @if($project['projectData']->submission_type == 'ONLINE'){{'selected'}} @endif>ONLINE</option>
                                                    <option value="OFFLINE" @if($project['projectData']->submission_type == 'OFFLINE'){{'selected'}} @endif>OFFLINE</option>
                                                </select>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="selectpicker" name="grading_required" id="grading_required" data-size="5" data-style="select-with-transition" data-live-search="true" title="Select" required="required" data-parsley-errors-container=".gradeError">
                                                    <option value="YES" @if($project['projectData']->grading_required == 'YES'){{'selected'}} @endif>YES</option>
                                                    <option value="NO" @if($project['projectData']->grading_required == 'NO'){{'selected'}} @endif>NO</option>
                                                </select>
                                        ...
                                        <div class="col-lg-6" id="grading_options">
                                            <div class="form-group">
                                                ...
                                                <select class="selectpicker" name="grading_option" id="grading_option" data-size="5" data-style="select-with-transition" data-live-search="true" title="Select" data-parsley-errors-container=".gradeOptionError">
                                                    <option value="GRADE" @if($project['projectData']->grading_option == 'GRADE'){{'selected'}} @endif>GRADE</option>
                                                    <option value="MARKS" @if($project['projectData']->grading_option == 'MARKS'){{'selected'}} @endif>MARKS</option>
                                                </select>
                                        ...
                                        <div class="col-lg-6" id="grade">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="project_grade" placeholder="Mention grade here (eg:A+,A,B...)" value="{{ $project['projectData']->grade }}" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6" id="marks">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="project_mark" placeholder="Mention max mark here" value="{{ $project['projectData']->marks }}" />
                                                <input type="hidden" id="grading_option_value" value="{{ $project['projectData']->grading_option }}">
                                                <input type="hidden" id="grading_required_value" value="{{ $project['projectData']->grading_required }}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="selectpicker" name="read_receipt" id="read_receipt" data-size="5" data-style="select-with-transition" data-live-search="true" title="Select" required="required" data-parsley-errors-container=".receiptError">
                                                    <option value="YES" @if($project['projectData']->read_receipt == 'YES'){{'selected'}} @endif>YES</option>
                                                    <option value="NO" @if($project['projectData']->read_receipt == 'NO'){{'selected'}} @endif>NO</option>
                                                </select>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="selectpicker" name="sms_alert" id="sms_alert" data-size="5" data-style="select-with-transition" data-live-search="true" title="Select" required="required" data-parsley-errors-container=".smsError">
                                                    <option value="YES" @if($project['projectData']->sms_alert == 'YES'){{'selected'}} @endif>YES</option>
                                                    <option value="NO" @if($project['projectData']->sms_alert == 'NO'){{'selected'}} @endif>NO</option>
                                                </select>
