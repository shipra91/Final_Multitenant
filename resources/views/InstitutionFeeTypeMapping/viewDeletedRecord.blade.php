            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 col-sm-offset-0 text-right">
                        <a href="{{ url('/etpl/institution-fee-type-mapping') }}" type="button" class="btn btn-primary"><i class="material-icons">menu</i> All Fee Type</a>
...
<script>
    $(document).ready(function(){
        ...
        var table = $('.data-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "/etpl/institution-fee-type-deleted-records",
            ajax: "/etpl/institution-fee-type-deleted-records",
            columns: [
        ...
        $(document).on('click', '.restore', function (e){
            ...
            if(confirm("Are you sure you want to restore this?")){
                ...
                $.ajax({
                    type: "GET",
                    url:"/etpl/institution-fee-type/restore/"+id,
                    dataType: "json",
                    data: {id:id},
