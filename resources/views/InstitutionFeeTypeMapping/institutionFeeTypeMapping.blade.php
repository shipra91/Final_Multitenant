                    ...
                    <div class="col-md-12 col-md-offset-0">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h4 class="card-title">Add Fee Type Mapping</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select class="selectpicker" name="fee_type[]" id="fee_type" data-style="select-with-transition" data-live-search="true" title="Select" data-size="5" data-actions-box="true" required="required" multiple>
                                        ...
                                        <div class="col-lg-4 col-lg-offset-0">
                                            <div class="form-group">
                                                ...
                                                <a href="{{ url('/etpl/institution-fee-type-mapping') }}" class="btn btn-finish btn-fill btn-wd btn btn-danger">Close</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
    ...
    $(document).ready(function(){
        ...
        $('body').delegate('#academicMappingForm', 'submit', function(e){
            ...
            if ($('#academicMappingForm').parsley().isValid()){
                ...
                $.ajax({
                    url:"/etpl/institution-fee-type-mapping",
                    type:"POST",
                    dataType:"json",
