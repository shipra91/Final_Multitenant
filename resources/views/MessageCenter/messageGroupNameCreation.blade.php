                    ...
                    <div class="col-md-12 col-md-offset-0">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h4 class="card-title">Add Message Group</h4>
                                <form method="POST" id="groupNameForm">
                                    ...
                                    <div class="col-lg-3 col-lg-offset-0">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-finish btn-fill btn-info btn-wd mr-5" name="submit" id="submit"> Submit</button>
                    ...
                    if(result['status'] == "200"){
                        ...
                        if(result.data['signal'] == "success"){
                            ...
                            swal({
                                ...
                                window.location.replace('/message-group-members/create');
                            }).catch(swal.noop)
