            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 col-sm-offset-0 text-right">
                        <a href="{{ url('/gallery') }}" type="button" class="btn btn-primary"><i class="material-icons">menu</i> All Gallery</a>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('.data-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "gallery-deleted-records",
            columns: [
                {data: 'DT_RowIndex', name: 'created_at', "width": "10%", className:"text-center"},
                {"data": "coverImage" ,
                    "render": function (data){
                        return "<img src='"+data+"' style='width:50px; height:50px;' class='rounded img-responsive'>";
                    },
                    "width": "20%"
                },
