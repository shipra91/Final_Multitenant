                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-content">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <table class="table table-bordered table-striped" id="studentTimeTable">
                                                <thead>
                                                    <tr>
                                                        <th colspan="10" style="text-align: center;"><span class="fw-600">Class Timetable - {{ ucwords($timetableData['student_name']) }}</span></th>
                                                    </tr>
