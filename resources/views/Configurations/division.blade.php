        ...
        <div class="content">
            <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-lg-offset-0">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="division_label" required />
                                            </div>
                                        </div>
                ...
                {{-- <div class="alert alert-danger" role="alert">
                    <strong>Note:</strong> The Division can not be edited or deleted if the standardyear is already mapped</p>
                </div> --}}
...
<script>
    $(document).ready(function(){
        ...
        $("#divisionForm").parsley({
            triggerAfterFailure: 'input change focusout changed.bs.select'
        });

        // Save division
        $('body').delegate('#divisionForm', 'submit', function(e){
            e.preventDefault();

            var btn=$('#submit');

            if ($('#divisionForm').parsley().isValid()){
