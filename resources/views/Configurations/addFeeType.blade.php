                    ...
                    <div class="col-md-12 col-md-offset-0">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <form method="POST" id="feeTypeForm" action="#">
                                    <div id="repeater">
                                        ...
                                        <div class="row" id="section_1" data-id="1">
                                            <div class="col-lg-4 col-lg-offset-0">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="feeType[]" id="feeType_1" required />
                                                </div>
                                            </div>
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click', '#add_more', function(){
            ...
            html += '<label class="control-label mt-0">Fee Type<span class="text-danger">*</span></label>';
            html += '<input type="text" class="form-control" name="feeType[]" id="feeType_'+count+'" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" required />';
            html += '</div>';
            html += '</div>';
