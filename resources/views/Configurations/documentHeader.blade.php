            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 col-sm-offset-0 text-right">
                        <a href="{{ url('/etpl/document-header/create') }}" type="button" class="btn btn-primary mr-5"><i class="material-icons">add</i> Add Document Header</a>
                    ...
                    <div class="col-md-12 col-md-offset-0">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h4 class="card-title">Document Header List</h4>
