        ...
        <div class="content">
            <div class="container-fluid">
                    ...
                    <div class="col-md-12 col-md-offset-0">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h4 class="card-title">Add Caste Category</h4>
                ...
                {{-- <div class="alert alert-danger" role="alert">
                    <strong>Note:</strong> The Caste Category can not be edited or deleted if the standardyear is already mapped</p>
                </div> --}}
