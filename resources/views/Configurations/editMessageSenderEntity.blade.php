                    ...
                    <div class="col-md-12 col-md-offset-0">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h4 class="card-title">Edit Sender & Entity Id</h4>
                                <form method="POST" id="messageSenderEntityForm">
                                    <div class="row">
                                        <input type="hidden" id="senderEntityId" value="{{$messageSenderEntityDetails->id}}">

                                        <div class="col-lg-4 col-lg-offset-0">
                                            <div class="form-group">
                                                <label class="control-label mt-0">Sender ID<span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="sender_id" id="sender_id" value ="{{$messageSenderEntityDetails->sender_id}}" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-lg-offset-0">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="entity_id" id="entity_id" value ="{{$messageSenderEntityDetails->entity_id}}" required />
                                            </div>
                                        </div>
