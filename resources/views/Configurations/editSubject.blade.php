                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="selectpicker" name="subject_type" id="subject_type" data-size="3" data-style="select-with-transition" data-live-search="true" title="Select" required="required">
                                                    @foreach($subjectTypes as $subjectType)
                                                        <option value="{{$subjectType->id}}" @if($subjectType->id == $subject->id_type) {{'selected'}} @endif>{{$subjectType->display_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-lg-offset-0">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="subject_name" id="subject_name" value="{{$subject->name}}" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-lg-offset-0">
                                            <div class="form-group">
                                                ...
                                                <a href="{{ url('/etpl/subject') }}" class="btn btn-finish btn-fill btn-wd btn btn-danger">Close</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                        ...
                        if(result['status'] == "200"){
                            ...
                            if(result.data['signal'] == "success"){
                                ...
                                swal({
                                    ...
                                    window.location.replace('/etpl/subject');
                                }).catch(swal.noop)
