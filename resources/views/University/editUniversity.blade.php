                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <form method="POST" id="universityForm" enctype="multipart/form-data">
                                    <div class="row">
                                        <input type="hidden" class="form-control" name="universitId" id="universitId" value="{{$selectedUniversity->id}}">
                                        <div class="col-lg-6 col-lg-offset-0">
                                            <div class="input-group p-t-10">
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" class="form-control" name="universityName" id="universityName" required onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" value="{{$selectedUniversity->name}}" />
                                                </div>
                                            </div>
                                        </div>
