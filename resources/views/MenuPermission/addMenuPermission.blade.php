                        ...
                        <div class="col-sm-12 col-sm-offset-0">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Add Role Menu Permission</h4>
                                    <div class="row">
                                        <input type="hidden" id="filepath" value="<?php echo $menuPath; ?>"/>
                                        <div class="col-lg-4 col-lg-offset-0">
                                            <div class="form-group">
                                                <label class="control-label mt-0">Role <span class="text-danger">*</span></label>
                                                <select class="selectpicker" name="role_name" data-style="select-with-transition" data-size="5" data-live-search="true" title="Select Role" data-actions-box="true" required>
                                                    @foreach($allData['roles'] as $index => $data)
                                                    ...
                                                    <tbody>
                                                            ...
                                                            @foreach($data['sub_modules'] as $key => $submodule)
                                                                <tr>
                                                                    ...
                                                                    <td class="checkbox no-border">
                                                                        <label class="fw-500"><input type="checkbox" class="view_{{ $data['module_label'] }}" name="action[{{ $submodule['id'] }}][]" value="view"/></label>
                                                                    </td>
                                                                    <td class="checkbox no-border">
                                                                        <label class="fw-500"><input type="checkbox" class="viewOwn_{{ $data['module_label'] }}" name="action[{{ $submodule['id'] }}][]" value="viewOwn}"/></label>
                                                                    </td>
                                                                    <td class="checkbox no-border">
                                                                        <label class="fw-500"><input type="checkbox" class="create_{{ $data['module_label'] }}" name="action[{{ $submodule['id'] }}][]" value="create"/></label>
                                                                    </td>
                                                                    <td class="checkbox no-border">
                                                                        <label class="fw-500"><input type="checkbox" class="edit_{{ $data['module_label'] }}" name="action[{{ $submodule['id'] }}][]" value="edit"/></label>
                                                                    </td>
                                                                    <td class="checkbox no-border">
                                                                        <label class="fw-500"><input type="checkbox" class="delete_{{ $data['module_label'] }}" name="action[{{ $submodule['id'] }}][]" value="delete"/></label>
                                                                    </td>
                                                                    <td class="checkbox no-border">
                                                                        <label class="fw-500"><input type="checkbox" class="export_{{ $data['module_label'] }}" name="action[{{ $submodule['id'] }}][]" value="export"/></label>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        ...
                                                        @else
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="checkbox no-border">
                                                                    <label class="fw-500"><input type="checkbox" class="view_{{ $data['module_label'] }}" name="action[{{ $data['id'] }}][]" value="view"/></label>
                                                                </td>
                                                                <td class="checkbox no-border">
                                                                    <label class="fw-500"><input type="checkbox" class="viewOwn_{{ $data['module_label'] }}" name="action[{{ $data['id'] }}][]" value="viewOwn"/></label>
                                                                </td>
                                                                <td class="checkbox no-border">
                                                                    <label class="fw-500"><input type="checkbox" class="create_{{ $data['module_label'] }}" name="action[{{ $data['id'] }}][]" value="create"/></label>
                                                                </td>
                                                                <td class="checkbox no-border">
                                                                    <label class="fw-500"><input type="checkbox" class="edit_{{ $data['module_label'] }}" name="action[{{ $data['id'] }}][]" value="edit"/></label>
                                                                </td>
                                                                <td class="checkbox no-border">
                                                                    <label class="fw-500"><input type="checkbox" class="delete_{{ $data['module_label'] }}" name="action[{{ $data['id'] }}][]" value="delete"/></label>
                                                                </td>
                                                                <td class="checkbox no-border">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pull-right">
                                <button type="submit" class="btn btn-finish btn-fill btn-info btn-wd mr-5" id="submit" name="submit" {{ (count($allData['modules'])) > 0 ?'':'disabled';}}>Submit</button>
