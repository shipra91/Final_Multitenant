            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 col-sm-offset-0 text-right">  
                        <a href="{{ url('application-setting') }}" type="button" class="btn btn-primary">All Settings</a>
                    ...
                    <div class="col-sm-12 col-sm-offset-0">  
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h4 class="card-title">View Preadmission Settings</h4>
                                <div class="toolbar">
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.restore', function (e) {
            ...
            $.ajax({
                type: "GET",
                url:"/application-setting/restore/"+id, 
                dataType: "json",
                data: {id:id},
        ...
        $(document).on('click', '.restoreAll', function (e) {
            ...
            $.ajax({
                type: "GET",
                url:"/application-setting/restore-all", 
                dataType: "json",
                success: function (result) {
                    if(result['status'] == "200"){
                        if(result.data['signal'] == "success") { 
