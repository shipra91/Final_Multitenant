                    ...
                    <div class="col-md-12 col-md-offset-0">
                        <div class="card">
                            ...
                            <div class="card-content">
                                   <h4 class="card-title">Application Fee Setting</h4>
                                   <form method="POST" id="applicationSettingForm" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-6">
                                                ...
                                                <select name="application" class="selectpicker" data-style="select-with-transition" data-size="3" class="form-control" title="Select Application" data-live-search="true" required>
                                            ...
                                            <div class="form-group col-lg-4">
                                                ...
                                                <input name="fee_amount" type="text" class="form-control" required>
                                            </div> 
                                            
                                            <div class="form-group col-lg-4">
                                                <label class="control-label">Receipt Prefix</label>
                                                <input name="receipt_prefix" type="text" class="form-control" required>
                                            </div> 
                                            
                                            <div class="form-group col-lg-4">
                                                <label class="control-label">Receipt Starting Number</label>
                                                <input name="receipt_starting_number" type="text" class="form-control" required>
                                            </div> 
                                        </div>
