            ...
            <div class="container">
                <div class="row" style="margin-top:80px;">
                    <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                        <form id="loginForm" method="POST" action="{{ url('/etpl/login') }}">
                            @csrf
                            <div class="card card-login card-hidden">
                                <div class="card-header text-center" data-background-color="mediumaquamarine">
                                    <h4 class="card-title mb-0 p2">Login</h4>
                                </div>
                                ...
                                <div class="footer row">
                                    <button type="submit" id="submit" class="btn btn-warning btn-simple btn-wd btn-lg">SignIn</button>
                                    <a href="/etpl/registration" type="button" id="submit" class="btn btn-warning btn-simple btn-wd btn-lg">SignUp</a>
                                </div>
                            </div>
                        </form>
                    </div>
