...
<div class="container-fluid">
        <div class="row mb-20">
            <div class="col-md-12">
                <button class="btn btn-primary" onclick="exportTableToExcel('tblData', 'feeCancellation-report<?php echo date('dmYhi'); ?>')">Export To Excel</button>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <table class="table" id="tblData" style="border-collapse:collapse;border:1px solid;">
                    <thead>
                        <tr><th colspan="12" class="text-center fw-500"><h3>{{ $institute->name }}</h3></th></tr>
                        <tr><th colspan="12" class="text-center fw-500">{{ $institute->address }}, {{ $institute->post_office }}, {{ $institute->pincode }}</th></tr>
                        <tr><th colspan="12" class="text-center fw-500">Fee Cancellation Report</th></tr>
                        <tr><th colspan="12" class="text-center fw-500">Generated Time : @php echo date('d/m/Y H:i:s'); @endphp</th></tr>
                        <tr>
                            ...
                            <th class="fw-500">COLLECTED AMOUNT</th>  
                            <th class="fw-500">CANCELLED DATE</th>
                            <th class="fw-500">CANCELLED REMARK</th>
                    ...
                    <tbody>
                        ...
                        @foreach($getReportData as $index => $reportData)
                            ...
                            <tr>
                                ...
                                <td>{{ $reportData['collected_amount'] }}</td>     
                                <td>{{ $reportData['cancelled_date'] }}</td>       
                                <td>{{ $reportData['cancellation_remarks'] }}</td>   
