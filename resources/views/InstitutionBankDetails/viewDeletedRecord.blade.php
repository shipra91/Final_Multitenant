            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 col-sm-offset-0 text-right">
                        <a href="{{ url('/institution-bank-details') }}" type="button" class="btn btn-primary"><i class="material-icons">menu</i> All Bank Details</a>
                    ...
                    <div class="col-sm-12 col-sm-offset-0">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h4 class="card-title">Deleted Bank Details List</h4>
...
<script>
    $(document).ready(function(){
        ...
        var table = $('.data-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "institution-bank-details-deleted-records",
            columns: [
        ...
        $(document).on('click', '.restore', function (e){
            ...
            if(confirm("Are you sure you want to restore this?")){
                ...
                $.ajax({
                    type: "GET",
                    url:"/institution-bank-details/restore/"+id,
                    dataType: "json",
                    data: {id:id},
