                                                ...
                                                <div class="col-sm-4 col-sm-offset-2">
                                                    <div class="fileinput fileinput-new text-center"
                                                        ...
                                                        <div class="fileinput-new thumbnail">
                                                            ...
                                                            <img class="img" src="{{$selectedStaff->staff_image}}"
                                                                alt="Image" />
                                                            @else
                                                        ...
                                                        <div>
                                                            <span class="btn btn-square btn-info btn-file btn-sm">
                                                                ...
                                                                <input type="hidden" name="oldstaffImage"
                                                                    value="{{$selectedStaff->staff_image}}" />
                                                            </span>
                                                            <a href="#pablo"
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control input"
                                                                name="staffName" id="staffName" minlength="2" required
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label">Date Of Birth<span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text" class="form-control custom_datepicker"
                                                                name="staffDob" id="staffDob"
                                                                value="{{Carbon::createFromFormat('Y-m-d', $selectedStaff->date_of_birth)->format('d/m/Y')}}"
                                                                required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" class="form-control datepicker"
                                                                ...
                                                                value="{{Carbon::createFromFormat('Y-m-d', $selectedStaff->joining_date)->format('d/m/Y')}}"
                                                                required />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="gender" id="gender"
                                                                ...
                                                                <option value="{{$gender->id}}" @if($selectedStaff->
                                                                    id_gender ==$gender->id) {{'selected'}}
                                                                    @endif>{{ucwords($gender->name)}}</option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="bloodGroup"
                                                                ...
                                                                <option value="{{$bloodGroup->id}}" @if($selectedStaff->
                                                                    id_blood_group ==$bloodGroup->id) {{'selected'}}
                                                                    @endif>{{$bloodGroup->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="designation"
                                                                ...
                                                                <option value="{{$designation->id}}"
                                                                    @if($selectedStaff->id_designation
                                                                    ==$designation->id) {{'selected'}}
                                                                    @endif>{{ucwords($designation->name)}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="department"
                                                                ...
                                                                <option value="{{$department->id}}" @if($selectedStaff->
                                                                    id_department ==$department->id) {{'selected'}}
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="staffRoll" id="staffRoll"
                                                                ...
                                                                <option value="{{$role->id}}" @if($selectedStaff->
                                                                    id_role ==$role->id) {{'selected'}}
                                                                    @endif>{{ucwords($role->display_name)}}</option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="staffCategory"
                                                                ...
                                                                @foreach($staffDetails['staffCategory'] as $staffCategory){
                                                                    <option value="{{$staffCategory->id}}"
                                                                    data-label="{{$staffCategory->label}}"
                                                                    @if($selectedStaff->id_staff_category
                                                                    ==$staffCategory->id) {{'selected'}}
                                                                    @endif>{{ucwords($staffCategory->name)}}</option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="staffSubcategory"
                                                                ...
                                                                <option value="{{$staffSubcategory->id}}"
                                                                    @if($selectedStaff->id_staff_subcategory
                                                                    ==$staffSubcategory->id) {{'selected'}}
                                                                    @endif>{{ucwords($staffSubcategory->name)}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="staffPhone"
                                                                ...
                                                                value="{{$selectedStaff->primary_contact_no}}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                minlength="10" maxlength="10" number="true"
                                                                onblur="this"
                                                                value="{{$selectedStaff->secondary_contact_no}}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" class="form-control" name="staffEmail"
                                                                id="staffEmail" value="{{$selectedStaff->email_id}}"
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{$selectedStaff->duration_employment}}" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane  wizard-pane" id="address">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="pincode"
                                                                ...
                                                                onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                                required value="{{$selectedStaff->pincode}}" />

                                                            <input type="hidden" name="city" id="city"
                                                                class="form-control" value="{{$selectedStaff->city}}" />
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="post_office" id="post_office"
                                                                ...
                                                                value="{{$selectedStaff->post_office}}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" rows="1" name="address"
                                                                id="address"
                                                                required>{{$selectedStaff->address}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>                                            
                                            ...
                                            <div id="repeater">
                                                <input type="hidden" name="totalCount" id="totalCount"
                                                    class="form-control" value="{{ count($selectedStaff['familyDetails']) > 0 ? count($selectedStaff['familyDetails']) : 1 }}">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                                            minlength="10" maxlength="10" number="true"
                                                                            onblur="this" value="{{ $familyDetails->phone }}" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-3 col-lg-offset-0">
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="familyRelation[]" id="familyRelation_1" value="{{ $familyDetails->relation }}" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="col-lg-12 col-lg-offset-0">
                                                <button id="add_more" type="button" class="btn btn-warning btn-md"><i class="material-icons">add_circle_outline</i> Add Family Details</button>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="nationality"
                                                                ...
                                                                <option value="{{$nationality->id}}"
                                                                    @if($selectedStaff->id_nationality
                                                                    ==$nationality->id) {{'selected'}}
                                                                    @endif>{{ucwords($nationality->name)}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="religion" id="religion"
                                                                ...
                                                                <option value="{{$religion->id}}" @if($selectedStaff->
                                                                    id_religion ==$religion->id) {{'selected'}}
                                                                    @endif>{{ucwords($religion->name)}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="cast" id="cast"
                                                                ...
                                                                <option value="{{$category->id}}" @if($selectedStaff->
                                                                    id_caste_category ==$category->id) {{'selected'}}
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="aadhaarNumber"
                                                                ...
                                                                onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                                value="{{$selectedStaff->aadhaar_no}}" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="panNumber"
                                                                id="panNumber" value="{{$selectedStaff->pancard_no}}" minlength="10" maxlength="10" number="true"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="uanNumber"
                                                                id="uanNumber" value="{{$selectedStaff->pf_uan_no}}" onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <div class="fileinput fileinput-new text-center"
                                                            ...
                                                            <div class="fileinput-new thumbnail img-square">
                                                                ...
                                                                <img class="img"
                                                                    src="{{$selectedStaff->attachment_aadhaar}}"
                                                                    alt="Image" />
                                                                @else
                                                                <img class="img"
                                                                    src="//cdn.egenius.in/img/placeholder.jpg"
                                                                    alt="Image" />
                                                                @endif
                                                            </div>
                                                            <div
                                                            ...
                                                            <div>
                                                                <span class="btn btn-square btn-info btn-file btn-sm">
                                                                    ...
                                                                    <input type="hidden" name="oldattachmentAadhaar"
                                                                        value="{{$selectedStaff->attachment_aadhaar}}" />
                                                                </span>
                                                                <a href="#pablo"
                                                                    class="btn btn-danger btn-square fileinput-exists btn-sm"
                                                                    data-dismiss="fileinput"><i
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <div class="fileinput fileinput-new text-center"
                                                            ...
                                                            <div class="fileinput-new thumbnail img-square">
                                                                ...
                                                                <img class="img"
                                                                    src="{{$selectedStaff->attachment_pancard}}"
                                                                    alt="Image" />
                                                                @else
                                                                <img class="img"
                                                                    src="//cdn.egenius.in/img/placeholder.jpg"
                                                            ...
                                                            <div>
                                                                <span class="btn btn-square btn-info btn-file btn-sm">
                                                                    ...
                                                                    <input type="hidden" name="oldattachmentPancard"
                                                                        value="{{$selectedStaff->attachment_pancard}}" />
                                                                </span>
                                                                <a href="#pablo"
                                                                    class="btn btn-danger btn-square fileinput-exists btn-sm"
                                                                    data-dismiss="fileinput"><i
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="head_teacher"
                                                                id="head_teacher" data-style="select-with-transition"
                                                                title="Select"
                                                                data-parsley-errors-container=".headError">
                                                                <option value="YES" @if($selectedStaff->head_teacher ==
                                                                    'YES' ) {{ "selected" }} @endif >YES</option>
                                                                <option value="NO" @if($selectedStaff->head_teacher ==
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="subject_specialization[]"
                                                                ...
                                                                data-style="select-with-transition"
                                                                data-live-search="true" multiple title="Select Subjects"
                                                                data-actions-box="true"
                                                                data-parsley-errors-container=".specializationError">
                                                                @foreach($subjects as $subject)
                                                                <option value="{{$subject['id']}}"
                                                                    @if(in_array($subject['id'], $subjectMapping))
                                                                    {{'selected'}} @endif>{{$subject['display_name']}}
                                                                </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="working_hour"
                                                                ...
                                                                <option value="FULL_TIME" @if($selectedStaff->
                                                                    working_hours == 'FULL_TIME' ) {{ "selected" }}
                                                                    @endif >Full Time</option>
                                                                <option value="PART_TIME" @if($selectedStaff->
                                                                    working_hours == 'PART_TIME' ) {{ "selected" }}
...
$(document).ready(function() {
    ...
    $(document).on('click', '#add_more', function() {
        ...
        html += '<button type="button" id="' + count +
            '" class="btn btn-danger btn-sm remove_button"><i class="material-icons">highlight_off</i></button>';
        html += '</div>';
        html += '</div>';
        html += '</div>';
