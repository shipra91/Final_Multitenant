                                    ...
                                    <div class="tab-content">
                                                        ...
                                                        <div class="col-sm-4 col-lg-offset-0">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="staffDob" id="staffDob" type="text" class="form-control custom_datepicker" data-style="select-with-transition" data-parsley-trigger="change" required />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="bloodGroup" id="bloodGroup" data-size="5" data-style="select-with-transition" data-live-search="true" title="Select">
                                                                @foreach($staffDetails['bloodGroup'] as $bloodGroup)
                                                                    <option value="{{$bloodGroup->id}}">{{ ucwords($bloodGroup->name) }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-3 col-lg-offset-0">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="designation" id="designation" data-size="5" data-style="select-with-transition" data-live-search="true" title="Select">
                                                ...
                                                <div class="col-lg-3 col-lg-offset-0">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="staffCategory" id="staffCategory" data-size="5" data-style="select-with-transition" data-live-search="true" title="Select Category"  required="required" data-parsley-errors-container=".categoryError">
                                                                @foreach($staffDetails['staffCategory'] as $cat)
                                                                    <option value="{{ $cat['id'] }}" data-label="{{ $cat['label'] }}">{{ $cat['name'] }}</option>
                                                                @endforeach
                                                            </select>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-lg-offset-0 d-none">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label mt-0">SMS For</label>
                                                            <select class="selectpicker" name="smsFor" id="smsFor" data-style="select-with-transition" title="Select">
                                                ...
                                                <div class="col-lg-3 col-lg-offset-0">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" class="form-control" name="staffEmail" id="staffEmail" data-parsley-type="email" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-lg-offset-0">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="employmentDuration" id="employmentDuration" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-3 col-lg-offset-0">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="post_office" id="post_office" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-lg-offset-0">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="taluk" id="taluk" class="form-control" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-lg-offset-0">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="district" id="district" class="form-control" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="nationality" id="nationality" data-size="5" data-style="select-with-transition" data-live-search="true" title="Select">
                                                                @foreach($staffDetails['nationality'] as $nationality)
                                                                    <option value="{{ $nationality->id }}">{{ ucwords($nationality->name) }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-3 col-lg-offset-0">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="aadhaarNumber" id="aadhaarNumber" minlength="12" maxlength="12" onkeypress="return event.charCode >= 48 && event.charCode <= 57" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-3 col-lg-offset-0">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="panNumber" id="panNumber" minlength='10' maxlength='10' />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-lg-offset-0">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="uanNumber" id="uanNumber" onkeypress="return event.charCode >= 48 && event.charCode <= 57" minlength='12' maxlength='12' />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="fileinput fileinput-new text-center"
                                                            ...
                                                            <div>
                                                                <span class="btn btn-square btn-info btn-file btn-sm">
                                                                    ...
                                                                    <input type="file" name="attachmentAadhaar" id="attachmentAadhaar" />
                                                                </span>
                                                                <a href="#pablo" class="btn btn-danger btn-square fileinput-exists btn-sm" data-dismiss="fileinput"><i class="material-icons">highlight_off</i></a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="fileinput fileinput-new text-center"
                                                            ...
                                                            <div>
                                                                <span class="btn btn-square btn-info btn-file btn-sm">
                                                                    <span class="fileinput-new">Add</span>
                                                                    <span class="fileinput-exists">Change</span>
                                                                    <input type="file" name="attachmentPancard" id="attachmentPancard" />
                                                                </span>
                                                                <a href="#pablo" class="btn btn-danger btn-square fileinput-exists btn-sm" data-dismiss="fileinput"><i class="material-icons">highlight_off</i></a>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-3 col-lg-offset-0">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="board[]" id="board" data-size="5" data-style="select-with-transition" data-live-search="true" data-selected-text-format="count > 1" title="Select Board" multiple data-actions-box="true" data-parsley-errors-container=".belongsToError" required>
                                                ...
                                                <div class="col-lg-3 col-lg-offset-0">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="head_teacher" id="head_teacher" data-size="5" data-style="select-with-transition" title="Select" data-parsley-errors-container=".headError" required>
                                                ...
                                                <div class="col-lg-3 col-lg-offset-0">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker" name="subject_specialization[]" id="subject_specialization" data-size="5" data-style="select-with-transition" data-live-search="true" data-actions-box="true" data-selected-text-format="count > 1" multiple title="Select Subjects" data-parsley-errors-container=".specializationError" required>
                                        ...
                                        <div class="wizard-footer">
                                            <div class="pull-right">
                                                <input type="button" class="btn btn-next btn-fill btn-info btn-wd" ame="next" value="Next" />
