            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 col-sm-offset-0 text-right">
                        <a href="{{ url('/homework') }}" type="button" class="btn btn-primary"><i class="material-icons">menu</i> All Homeworks</a>
...
<script>
    $(document).ready(function(){
        ...
        var table = $('.data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "homework-deleted-records",
            columns: [
                {data: 'DT_RowIndex', name: 'created_at', "width": "8%", className:"text-center"},
