            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 col-sm-offset-0 text-right">
                        <a href="{{url('homework')}}" class="btn btn-finish btn-fill btn-wd btn btn-info"><i class="material-icons">arrow_back</i> Back</a>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12 col-sm-offset-0">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <input type="hidden" id="homeworkId" value="{{ request()->route()->parameters['id'] }}"/>
    ...
    <div class="modal-dialog">
        <form method="POST" id="permissionForm" enctype = "multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body1 col-lg-12 col-sm-12 mb-20">
...
<div class="modal fade" id="homework_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" id="markCommentForm" enctype = "multipart/form-data">
            <input type="hidden" id="id_homework_submission">
...
<script>
    $(document).ready(function(){
        ...
        var table = $('.data-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "/homework-submission-student/"+homeworkId,
            columns: [
        ...
        $("body").delegate(".giveResubmissionPermission", "click", function(event){
            ...
            $.ajax({
                url:"{{ url('/homework-valuation-details') }}",
                type : "post",
                dataType : "json",
                ...
                success : function(response){
                    ...
                    $("#resubmission_permission_modal").find("#homework_name").text("Homework Name: "+response.homework_name);
                    ...
                    $("#resubmission_permission_modal").find("#homework_id").val(homeworkId);
        ...
        $('body').delegate('#permissionForm', 'submit', function(e){
            ...
            $.ajax({
                url:"/homework-submission-permission",
                type:"POST",
                dataType:"json",
        ...
        $("body").delegate(".addMarkComment", "click", function(event){
            ...
            $.ajax({
                ...
                success : function(response){
                    ...
                    $("#homework_modal").find("#resubmissionOption").html(resubmissionOption);
                    // $("#resubmission_permission_modal").find("#student_id").val(studentId);
                    $("#homework_modal").find("#resubmissionDate").val(response.resubmission_date);
                    $("#homework_modal").find("#resubmissionTime").val(response.resubmission_time);
                    $("#homework_modal").find("#grading_option").val(response.grading_option);

                    $("#homework_modal").find("#gradeValues").val(response.grade_values);
                    $("#homework_modal").find("#maxMarksValue").val(response.marks);
                    $("#homework_modal").find("#obtainedMark").val(response.obtained_marks);

                    $("#homework_modal").find("#grade").html(gradeValue);
                    $("#homework_modal").find("#marks").html(marksValue);
                    $("#homework_modal").find("#max_marks").val(response.marks);
                    $("#homework_modal").find("#id_homework_submission").val(response.id_homework_submission);
                    $("#homework_modal").find("#comment").val(response.comments);
        ...
        $('body').delegate('#markCommentForm', 'submit', function(e){
            ...
            var btn = $('#submit');
            var id = $("#id_homework_submission").val();
