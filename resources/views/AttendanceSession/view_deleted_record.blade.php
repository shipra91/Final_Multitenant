            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 col-sm-offset-0 text-right">
                        <a href="{{ url('attendance-session') }}" type="button" class="btn btn-primary"><i class="material-icons">menu</i> All Session</a>
...
<script>
    $(document).ready(function(){
        ...
        var table = $('.data-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ url('/attendance-session-deleted-records')}}",
            columns: [
        ...
        $(document).on('click', '.restore', function (e){
            ...
            $.ajax({
                type: "GET",
                url:"/attendance-session/restore/"+id,
                dataType: "json",
                data: {id:id},
