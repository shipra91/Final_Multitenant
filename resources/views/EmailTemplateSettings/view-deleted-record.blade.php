            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 col-sm-offset-0 text-right">
                        <!-- {{-- <a href="{{ url('/etpl/email-template') }}" type="button" class="btn btn-primary mr-5"><i class="material-icons">menu</i> All Email Templates</a> --}} -->
...
<script>
    $(document).ready(function() {
        ...
        var table = $('.data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "/etpl/email-deleted-template",
            columns: [
        ...
        $(document).on('click', '.restore', function (e){
            ...
            $.ajax({
                type: "GET",
                url:"/etpl/email-template/restore/"+id,
                dataType: "json",
                data: {id:id},
        ...
        //     $.ajax({
        //         type: "GET",
        //         url:"/email-template/restore-all",
        //         dataType: "json",
        //         success: function (result) {
