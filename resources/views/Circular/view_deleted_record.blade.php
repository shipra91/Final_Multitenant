            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 col-sm-offset-0 text-right">
                        <a href="{{ url('/circular') }}" type="button" class="btn btn-primary"><i class="material-icons">menu</i> All Circulars</a>
                    ...
                    <div class="col-sm-12 col-sm-offset-0">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h4 class="card-title">Circulars List</h4>
