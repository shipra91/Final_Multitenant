                ...
                <div class="row">
                    <div class="col-sm-12 col-sm-offset-0 text-right">
                        @if(Helper::checkAccess('circular', 'create'))
                            <a href="{{ url('circular/create') }}" type="button" class="btn btn-primary mr-5"><i class="material-icons">add</i> Add Circular</a>
                        @endif
                        @if(Helper::checkAccess('circular', 'view'))
                            <a href="{{ url('circular-deleted-records') }}" type="button" class="btn btn-info"><i class="material-icons">delete_forever</i> Deleted Records</a>
                        @endif
                    </div>
                </div>
                        ...
                        <div class="col-sm-12 col-sm-offset-0">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Circular List</h4>
    ...
    $(document).ready(function(){
        ...
        var table = $('.data-table').DataTable({
            ...
            columns: [
                ...
                {data: 'circular_title', name: 'circular_title', "width": "27%"},
